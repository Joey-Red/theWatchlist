...
function Settings({ user, setUser, setLoggedIn }: SettingsProps) {
    ...
    return (
        ...
        >
            ...
            {pwStepOne && (
                <div className="bg-neutral-900/90 w-[80%] rounded mx-auto flex flex-col p-9 mt-24">
                    ...
                    <div className="flex justify-center w-full text-white gap-2 flex-col">
                        ...
                        {noMatch && (
                            <p className="text-[red] text-center">
                                New password must be the same as new confirm new
                                password and password must be at least 6
                                characters.
                            </p>
                        )}
                        {err && (
                ...
                <div className="bg-neutral-900/90 w-[80%] rounded mx-auto flex flex-col p-9 mt-4">
                    ...
                    <div className="flex justify-center w-full text-white">
                        <button
                            ...
                            className="text-red hover:border hover:border-2 rounded px-2 hover:border-[red]"
                        >
                            Delete it
                        </button>
                        <button
                            onClick={() => setStepOne(false)}
                            className="text-red hover:border hover:border-2 rounded px-2 hover:border-[green]"
                        >
                            No, I misclicked!
                        </button>
                    </div>
            ...
            <p className="underline text-3xl text-center  my-4">Contact</p>
            ...
            <div className="flex justify-evenly mt-auto bg-slate-900/90">
                ...
                <div className="hover:scale-125 hover:text-[#1E9BF0] p-2 flex justify-center text-white align-center my-auto mx-auto">
                    <a href="https://twitter.com/JoeyDalrymple_" target="blank">
                        <FontAwesomeIcon
                            icon={faTwitter}
                            size="2xl"
                            className=" my-auto flex"
