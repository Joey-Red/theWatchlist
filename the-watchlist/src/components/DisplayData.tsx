                    ...
                    <div className="mt-4 flex">
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            {!showPoster && (
                                <button
                                    onClick={changePoster}
                                    className="z-10 border border-black p-2 rounded bg-neutral-900/80 text-neutral-300 max-w-fit mb-4"
                                >
                                    Show Posters
                                </button>
                            )}

                            <h3 className="underline max-w-[60ch]">Title</h3>
                            ...
                            <h3 className="underline max-w-[60ch]">Actors</h3>
                            <p>{actors}</p>
                        ...
                        <div className="text-white">
                            ...
                            <div className="slidecontainer">
                                <input
                                    ...
                                    id="myRange"
                                    onChange={(e) =>
                                        setUserRating(e.target.valueAsNumber)
                                    }
                                    value={userRating}
                                />
                                <div>{userRating}</div>
                            </div>
                            <p>Would you like to comment on the movie?</p>
                            <div>
                                <textarea
                                    name="movie comment"
                            ...
                            <div className="flex justify-end">
                                <button
                                    className="border border-black p-2 rounded text-black hover:scale-75 bg-[#1E75FF]"
                                    onClick={handleSubmit}
                                    disabled={
                                        !seen && comment === "" && !planSee
                                    }
                                >
                                    Submit
                                </button>
