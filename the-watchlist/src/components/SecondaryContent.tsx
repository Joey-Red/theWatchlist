...
function SecondaryContent() {
    ...
    let [loadingSimilar, setLoadingSimilar] = useState(true);
                        ...
                        <div className="">
                            <div className="flex flex-col justify-between h-full gap-2 max-h-[600px] overflow-y-scroll">
                                <div className="bg-slate-900/90 flex-col flex sm:min-h-[600px] rounded">
                                    ...
                                    >
                                        <div className="bg-neutral-900/90 h-40 z-20 flex flex-col justify-center text-2xl">
                                            <p>{topThree[0].film.movieName}</p>
                                            <p>
                                                Average Rating:{" "}
                                                {topThree[0].film.movieRating}
                                            </p>
                                        </div>
                                        <div
                                            style={{
                                ...
                                <div className="bg-slate-900/90 flex-col flex sm:min-h-[600px] rounded">
                                    ...
                                    <div className="h-full relative flex flex-col text-white text-xl text-center justify-center">
                                        <div className="bg-neutral-900/90 z-20 h-40 flex flex-col justify-center text-2xl">
                                            <p>{topThree[1].film.movieName}</p>
                                            <p>
                                                Average Rating:{" "}
                                                {topThree[1].film.movieRating}
                                            </p>
                                        </div>
                                        <div
                                            style={{
